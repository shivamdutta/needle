                ...
                try:
                    ...
                    for company in companies_to_trade_high:
                        ...
                        if order_status['order_id']=='order_failed':
                            ...
                            self.quantity_high.loc[(self.quantity_high['instrument']==company) & (self.quantity_high['order_id']=='to_be_placed'), 'order_type'] = order_status['order_type']
                            ...
                            self.quantity_high_to_be_placed.loc[(self.quantity_high_to_be_placed['instrument']==company) & (self.quantity_high_to_be_placed['order_id']=='to_be_placed'), 'order_type'] = order_status['order_type']
